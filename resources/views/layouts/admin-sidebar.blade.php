<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a title="Thu gọn" class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
          </li>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a title="Toàn màn hình" class="nav-link" data-widget="fullscreen" href="#" role="button">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('admin.home') }}" class="brand-link">
          <img src="{{ asset('asset/admin/dist/img/AdminLogo.png') }}" alt="Logo Admin" class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light">
            {{-- kiểm tra người dùng đăng nhập có role_id = 1 thì là quản trị viên còn bằng 2 là nhân viên --}}
            {{ (Auth::guard('admin')->user()->role_id == 1) ? 'Trang Quản Trị' : 'Trang Nhân Viên'}}
          </span>
        </a>
