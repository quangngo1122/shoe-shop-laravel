...
<html>
   <head>
      ...
      <link rel="shortcut icon" href="{{ asset('asset/client/images/logoweb.png') }}">
...
#myBtn {
  ...
  .nav .open > a, .nav .open > a:hover, .nav .open > a:focus{
   border-color:blue;
   background-color: rgb(149, 164, 180);
                  ...
                  <div class="col-md-2 col-sm-2">
                     <div class="logo">
                        <a href="{{ route('user.home') }}">
                           <img src="{{ asset("asset/client/images/" . setting_website()->logo) }}" alt="QuangShop">
                        </a>
                     </div>
                  </div>
                  <div class="col-md-10 col-sm-10">
                     <div class="header_top">
                        <div class="row">
                           <div class="col-md-6">
                              <!-- <ul class="topmenu">
                                 <li><a href="https://www.facebook.com/profile.php?id=100025837986643"><i class="fab fa-facebook"></i></a></li>
                                 <li><a href="https://www.youtube.com/channel/UCNdAHTvyoSgJcZtmHe2gRiQ"><i class="fab fa-youtube"></i></a></li>
         ...
         <div class="footer">
            ...
            <div class="copyright-info">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <p>Copyright © 2024. Designed by <a href="#">QuangDepTrai</a>. All rights reseved</p>
                     </div>
                     <div class="col-md-6">
