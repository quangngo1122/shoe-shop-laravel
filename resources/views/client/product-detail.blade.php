        ...
        <div class="col-md-12">
          <div class="products-details">
            <div class="preview_image">
              <div id="container2" class="preview-small text-center">
                <img class = "thumbnailimg2"id="zoom_03" src="{{ asset("assets/client/images/products/small/$product->img") }}" data-zoom-image="{{ asset("assets/client/images/products/small/$product->img") }}" alt="">
              </div>
              <script>
                const container = document.querySelector(".preview-small");
                const img = document.getElementById("zoom_03");
                container.addEventListener("mousemove",(e)=>{
                    const x = 0.5*e.clientX - e.target.offsetLeft;
                    const y = 0.5*e.clientY - e.target.offsetTop;
                    console.log(x,y);
              ...
              <div class="thum-image">
                <ul id="gallery_01" class="prev-thum">
                  @foreach ($productColor as $color)
                    <li class="sub-img">
                      <a href="#" data-image="{{ asset("assets/client/images/products/small/$color->img") }}" data-zoom-image="{{ asset("assets/client/images/products/small/$color->img") }}">
                        <img src="{{ asset("assets/client/images/products/small/$color->img") }}" alt="">
                      </a>
                    </li>
                  @endforeach
                </ul>
            ...
            <div class="title-review">
              <ul>
                <li style="display:flex">
                  ...
                  <p style="color:red;font-size:13px;  margin-top:5px; margin-left:20px;margin-bottom:0px;">
                    *Lưu ý:</p>
                  <p style="font-size:13px; margin-top:10px; margin-left:5px;margin-bottom:0px;">
                    Bạn có thể xem đánh giá<br>
                    Bạn có thể đánh giá khi đã mua sản phẩm đó</p>  
                </li>
              </ul>
            </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                      <div class="products">
                        <div class="thumbnail text-center">
                          <img src="{{ asset("assets/client/images/products/small/$relatedProduct->img") }}" alt="Product Name">
                        </div>
