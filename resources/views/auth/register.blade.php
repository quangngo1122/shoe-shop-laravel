                        ...
                        <div class="run-customer">
                          ...
                          <form action="{{ route('user.register') }}" method="POST" id="form__js">
                            ...
                            <div class="form-group">
                              <label style="display:flex;" for="exampleInputEmail1">Họ Và Tên <p style="color:red;">*</p></label>
                              <input type="text" class="form-control" value="{{ old('name') }}" id="name" name="name" aria-describedby="emailHelp" placeholder="Nhập họ và tên" autofocus>
                            ...
                            <div class="form-group">
                              <label style="display:flex;" for="exampleInputPassword1">Xác Nhận Mật Khẩu<p style="color:red;">*</p></label>
                            ...
                            <div class="form-group">
                              <label style="display:flex;" for="exampleInputEmail1">Số Điện Thoại<p style="color:red;">*</p></label>
                            ...
                            <div class="form-group">
                              <label style="display:flex;" for="exampleInputEmail1">Tỉnh, Thành Phố<p style="color:red;">*</p></label>
                            ...
                            <div class="form-group">
                              <label style="display:flex;" for="exampleInputEmail1">Quận, Huyện<p style="color:red;">*</p></label>
                            ...
                            <div class="form-group">
                              <label style="display:flex;" for="exampleInputEmail1">Phường Xã<p style="color:red;">*</p></label>
                            ...
                            <div class="form-group">
                              <label style="display:flex;" for="exampleInputEmail1">Địa Chỉ Nhà<p style="color:red;">*</p></label>
