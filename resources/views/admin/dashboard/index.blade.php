...
<div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('asset/client/images/1721550954.png') }}" alt="" height="300" width="300">
  </div>
    <!-- Main content -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-4 col-6">
            <!-- small box -->
           <x-box-dashboard :data="$revenue" title="Tổng Doanh Thu" route="doanhthu" boxtype="danger" ion="ion-calculator"/>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$profit" title="Tổng Lợi Nhuận" route="loinhuan" boxtype="success" ion="ion-cash"/>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$orders" title="Tổng Đơn Hàng" route="donhang" boxtype="warning" ion="ion-bag"/>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$products" title="Tổng Sản Phẩm Tồn Kho" route="tonkho" boxtype="primary" ion="ion-ios-home-outline"/>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$users" title="Tổng Khách Hàng" route="khachhang" boxtype="warning" ion="ion-person-add"/>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$admins" title="Tổng Nhân Sự" route="sanpham" boxtype="info" ion="ion-person-stalker"/>
          </div>
          <div class="col-md-12">
             <!-- STACKED BAR CHART -->
